...
//Answer: Contant time 0(1) - No matter how many people
...
//Answer: Linear time 0(1) - run times proportional to size of input, if there are 15 people or 150 people
// that's how many people you will need to ask and how long it will take
...
//Answer: Constant time 0(1) - no matter what the input there are only two possible answers
...
//Answer: Polynomial time 0(n^k) - in this case we have two nested loops, so
//time completxity grows more quickly than inputs
...
//Answer: Linear time 0(n) - running time directly proportional to size of input
...
//Answer: Linear time - running times are directly proportional to the size
//of the input
...
//Answer: Polynomial time 0(n^k)  - here you have nested loops again 
...
//Answer: Constant time (0)1 - no matter what the input it will take the same amount of time.
...
//Answer: Algorithm is testing to see if n is a prime or even number. Running time directly proportional
//to input - Linear time 0(n)
